 ...
 *
 * This component provides a modal for adding a new apartment. It includes a form with various
 * input fields for entering apartment details, and it handles the submission of the form to
 * add a new apartment.
 *
 * @component
 ...
 * @param {Function} props.onAddApartment - Callback function to handle adding a new apartment
 */
