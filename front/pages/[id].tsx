...
/**
 * ApartmentDetails Component displays details of a specific apartment.
 * @component
 */
const ApartmentDetails: React.FC = () => {
  ...
  useEffect(() => {
    /**
     * Fetches details of the specified apartment from the server.
     */
  ...
  /**
   * Renders the ApartmentDetails component.
   */
  if (!apartment) {
    return <p>Loading...</p>;
  }
